  ...
  const data = [
    {
      ...
      type: "mern",
      image:
        "https://res.cloudinary.com/djlxdttvr/image/upload/v1764570032/church-of-the-king-j9jZSqfH5YI-unsplash_jcuwet.jpg",
    ...
    },
    {
      ...
      type: "mern",
      image:
        "https://res.cloudinary.com/djlxdttvr/image/upload/v1764570015/boliviainteligente-IPIwk-Ox1A0-unsplash_c9dn2n.jpg",
    ...
    },
    {
      ...
      type: "frontend",
      image:
        "https://res.cloudinary.com/djlxdttvr/image/upload/v1764570057/martin-martz-CiQ2qEYVo5U-unsplash_l7s7fn.jpg",
      title: "To Do List App",
      description:
        "A minimal and responsive To-Do List application that helps users manage tasks efficiently. Users can add new tasks, mark completed items, edit them, and delete tasks once done. Built using React and Tailwind CSS with smooth UI interactions for an organized workflow.",
      language: ["HTML,CSS,Tailwind CSS,React"],
      frontendlink: "https://github.com/deiveegaponmari/todolist",
      demo: "https://todolisttrackerapp.netlify.app/",
    },
  ];
  const mernProjects = data.filter(p => p.type === "mern");
const frontendProjects = data.filter(p => p.type === "frontend");
